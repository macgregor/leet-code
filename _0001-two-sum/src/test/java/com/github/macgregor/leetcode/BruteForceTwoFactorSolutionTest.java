...
public class BruteForceTwoFactorSolutionTest {
    ...
    public void basicTest(Profiler profiler){
        ...
        Solution solution = new BruteForceTwoSumSolution(profiler);
        int[] actual = ((BruteForceTwoSumSolution) solution).twoSum(input, target);
