...
public class OnePassHashSolutionTest {
    ...
    public void basicTest(Profiler profiler){
        ...
        Solution solution = new OnePassHashTableSolution(profiler);
        int[] actual = ((OnePassHashTableSolution) solution).twoSum(input, target);
